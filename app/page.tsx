      ...
      <div className="relative w-full h-screen overflow-hidden">
        ...
        <nav className="relative z-10 flex items-center justify-between px-4 md:px-8 lg:px-28 py-8">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            <Link href="/services" className="text-white font-inter font-bold text-sm hover:text-authority-lime transition-colors">Services</Link>
            <Link href="/insights" className="text-white font-inter font-bold text-sm hover:text-authority-lime transition-colors">Insights</Link>
            <Link href="/stories" className="text-white font-inter font-bold text-sm hover:text-authority-lime transition-colors">Stories</Link>
            <Link href="/careers" className="text-white font-inter font-bold text-sm hover:text-authority-lime transition-colors">Careers</Link>
            <Link href="/about" className="text-white font-inter font-bold text-sm hover:text-authority-lime transition-colors">About Us</Link>
          </div>
